...
var MapsLib = {
  ...
  fusionTableId:      "1ysWzkdQXT3gD_VLKO2IDK8i_zLSwhnrcHlSYclX_", //Point data layer
  ...
  googleApiKey:       "AIzaSyCrpFlaiqwl3V1Q5BnTDuP8-8yYJgDKZkU",
  ...
  map_centroid:       new google.maps.LatLng(-2.506,37.497), //center that your map defaults to
  locationScope:      "kenya",      //geographical area appended to all address searches
  ...
  displayList: function(json) {
    ...
    if (rows == null) {
      ...
      $("#list_table").dataTable({
          "aaSorting": [[1, "asc"]], //default column to sort by (School)
